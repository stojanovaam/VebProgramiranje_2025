...
public class DishServiceImpl implements DishService {
    ...
    @Override
    public Dish create(String dishId, String name, String cuisine, int preparationTime, Long chefId, DishRank dishRank, Double rating) {
        Chef chef=chef_service.findById(chefId);
        Dish dish=new Dish(dishId,name,cuisine,preparationTime,chef,dishRank,rating);
        dish_repo.save(dish);   //ako objektot vekje postoi se azhurira, ako ne postoi se zachuvuva kako nov
        return dish;
    }

    @Override
    public Dish update(Long id, String dishId, String name, String cuisine, int preparationTime, Long chefId, DishRank dishRank, Double rating) {
